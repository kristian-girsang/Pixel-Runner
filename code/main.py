...
# create class that inherite from another class called sprite
# create sprite > place prites in Group of GroupSingle > draw/update all sprites in that group
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # has 2 attribute at the very minimum
